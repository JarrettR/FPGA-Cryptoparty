...
/*	    int m=(b[1] & 255) | (b[2] & 255)<<8 | (b[3] & 255)<<16;
	    int l=-1;
	    for (int k=4; (k<bb && l<0); k+=4 ) {
		int n=(b[k+1] & 255) | (b[k+2] & 255)<<8 | (b[k+3] & 255)<<16;
		if ( n!=((m+0x030303) & 0xffffff) ) l=k;
		m = n;
	    }*/
...
// upload the firmware if necessary
	    if ( force || ! ztex.valid() || ! ztex.dev().productString().equals("memfifo for UFM 2.04") ) {
