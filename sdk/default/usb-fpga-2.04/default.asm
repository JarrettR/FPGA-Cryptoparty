...
; This file was generated Thu Jul  3 16:23:53 2014
;--------------------------------------------------------
	.module default_tmp
...
;------------------------------------------------------------
;	../../include/ztex.h:276: void mac_eeprom_init ( ) { 
;	-----------------------------------------
;	 function mac_eeprom_init
;	-----------------------------------------
_mac_eeprom_init:
;	../../include/ztex.h:281: mac_eeprom_read ( buf, 0, 3 );	// read signature
	mov	_mac_eeprom_read_PARM_2,#0x00
	mov	_mac_eeprom_read_PARM_3,#0x03
	mov	dptr,#_mac_eeprom_init_buf_1_1
	lcall	_mac_eeprom_read
;	../../include/ztex.h:282: if ( buf[0]==67 && buf[1]==68 && buf[2]==48 ) {
	mov	dptr,#_mac_eeprom_init_buf_1_1
	movx	a,@dptr
	mov	r2,a
	cjne	r2,#0x43,00102$
	...
	mov	r2,a
	cjne	r2,#0x30,00102$
;	../../include/ztex.h:283: config_data_valid = 1;
	mov	dptr,#_config_data_valid
	mov	a,#0x01
	movx	@dptr,a
;	../../include/ztex.h:284: mac_eeprom_read ( SN_STRING, 16, 10 );	// copy serial number
	...
	sjmp	00123$
00102$:
;	../../include/ztex.h:287: config_data_valid = 0;
	mov	dptr,#_config_data_valid
	clr	a
	movx	@dptr,a
;	../../include/ztex.h:290: for (b=0; b<10; b++) {	// abort if SN != "0000000000"
00123$:
	mov	r2,#0x00
00108$:
	cjne	r2,#0x0A,00133$
00133$:
	jnc	00111$
;	../../include/ztex.h:291: if ( SN_STRING[b] != 48 )
	mov	a,r2
	add	a,#_SN_STRING
	mov	dpl,a
	clr	a
	...
	movx	a,@dptr
	mov	r3,a
;	../../include/ztex.h:292: return;
	cjne	r3,#0x30,00116$
;	../../include/ztex.h:290: for (b=0; b<10; b++) {	// abort if SN != "0000000000"
	inc	r2
	sjmp	00108$
00111$:
;	../../include/ztex.h:295: mac_eeprom_read ( buf, 0xfb, 5 );	// read the last 5 MAC digits
	mov	_mac_eeprom_read_PARM_2,#0xFB
	mov	_mac_eeprom_read_PARM_3,#0x05
	mov	dptr,#_mac_eeprom_init_buf_1_1
	lcall	_mac_eeprom_read
;	../../include/ztex.h:297: c=0;
	mov	r2,#0x00
;	../../include/ztex.h:298: for (b=0; b<5; b++) {	// convert to MAC to SN string
	mov	r3,#0x00
00112$:
	cjne	r3,#0x05,00136$
00136$:
	jnc	00116$
;	../../include/ztex.h:299: d = buf[b];
	mov	a,r3
	...
	movx	a,@dptr
	mov	r4,a
;	../../include/ztex.h:300: SN_STRING[c] = hexdigits[d>>4];
	mov	a,r2
	add	a,#_SN_STRING
	mov	r5,a
	clr	a
	...
	mov	dph,r6
	movx	@dptr,a
;	../../include/ztex.h:301: c++;
	inc	r2
;	../../include/ztex.h:302: SN_STRING[c] = hexdigits[d & 15];
	mov	a,r2
	add	a,#_SN_STRING
	mov	r5,a
	clr	a
...
;------------------------------------------------------------
;------------------------------------------------------------
;	../../include/ztex.h:352: void init_USB ()
;	-----------------------------------------
;	 function init_USB
;	-----------------------------------------
_init_USB:
;	../../include/ztex.h:354: USBCS |= bmBIT3;
	mov	dptr,#_USBCS
	movx	a,@dptr
	orl	a,#0x08
	movx	@dptr,a
;	../../include/ztex.h:356: CPUCS = bmBIT4 | bmBIT1;
	mov	dptr,#_CPUCS
	mov	a,#0x12
	movx	@dptr,a
;	../../include/ztex.h:357: wait(2);
	mov	dptr,#0x0002
	lcall	_wait
;	../../include/ztex.h:358: CKCON &= ~7;
	anl	_CKCON,#0xF8
;	../../include/ztex.h:387: init_fpga();
	lcall	_init_fpga
;	../../include/ztex-fpga-flash2.h:105: fpga_flash_result= 255;
	mov	dptr,#_fpga_flash_result
	mov	a,#0xFF
	movx	@dptr,a
;	../../include/ztex.h:392: EA = 0;
	clr	_EA
;	../../include/ztex.h:393: EUSB = 0;
	clr	_EUSB
...
;	../../include/ezintavecs.h:117: $0.addrL=(unsigned short)(&$1);
	...
	mov	a,r2
	movx	@dptr,a
;	../../include/ztex.h:414: EXIF &= ~bmBIT4;
	anl	_EXIF,#0xEF
;	../../include/ztex.h:415: USBIRQ = 0x7f;
	mov	dptr,#_USBIRQ
	mov	a,#0x7F
	movx	@dptr,a
;	../../include/ztex.h:416: USBIE |= 0x7f; 
	mov	dptr,#_USBIE
	movx	a,@dptr
	mov	r2,a
	orl	a,#0x7F
	movx	@dptr,a
;	../../include/ztex.h:417: EPIRQ = 0xff;
	mov	dptr,#_EPIRQ
	mov	a,#0xFF
	movx	@dptr,a
;	../../include/ztex.h:418: EPIE = 0xff;
	mov	dptr,#_EPIE
	mov	a,#0xFF
	movx	@dptr,a
;	../../include/ztex.h:420: EUSB = 1;
	setb	_EUSB
;	../../include/ztex.h:421: EA = 1;
	setb	_EA
;	../../include/ztex.h:340: EP$0CFG = bmBIT7 | bmBIT5;
	mov	dptr,#_EP1INCFG
	mov	a,#0xA0
	movx	@dptr,a
;	../../include/ezregs.h:46: __endasm;
...
;	../../include/ztex.h:441: flash_init();
	lcall	_flash_init
;	../../include/ztex.h:442: if ( !flash_enabled ) {
	mov	dptr,#_flash_enabled
	movx	a,@dptr
	mov	r2,a
	jnz	00102$
;	../../include/ztex.h:443: wait(250);
	mov	dptr,#0x00FA
	lcall	_wait
;	../../include/ztex.h:444: flash_init();
	lcall	_flash_init
00102$:
;	../../include/ztex.h:454: mac_eeprom_init();
	lcall	_mac_eeprom_init
;	../../include/ztex.h:460: fpga_configure_from_flash_init();
	lcall	_fpga_configure_from_flash_init
;	../../include/ztex.h:463: USBCS |= bmBIT7 | bmBIT1;
	mov	dptr,#_USBCS
	movx	a,@dptr
	orl	a,#0x82
	movx	@dptr,a
;	../../include/ztex.h:464: wait(10);
	mov	dptr,#0x000A
	lcall	_wait
;	../../include/ztex.h:466: USBCS &= ~bmBIT3;
	mov	dptr,#_USBCS
	movx	a,@dptr
	anl	a,#0xF7
	movx	@dptr,a
...
_manufacturerString:
	...
	.db 0x00
_productString:
	.ascii "USB-FPGA Module 2.04  (default)"
	.db 0x00
