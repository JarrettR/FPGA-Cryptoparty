/*!
   WPA2 -- EZ-USB FIFO interface for WPA2 testing on ZTEX USB-FPGA Module 1.15y and 1.15y2
...
// upload the firmware if necessary
	    if ( force || ! ztex.valid() || ! ztex.dev().productString().equals("WPA2 UFM 1.15y 0.1")  ) {
...
// upload the bitstream if necessary
		...
		if ( force || ! ztex.getFpgaConfiguration() ) {
		    ...
		    System.out.println("FPGA configuration time: " + ztex.configureFpga( "../hdl/out/wpa2.bit" , force ) + " ms");
		}
	    } 
